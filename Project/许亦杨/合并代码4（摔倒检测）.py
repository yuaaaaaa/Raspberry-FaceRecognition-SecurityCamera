# -*- coding: utf-8 -*-
"""
Created on Mon Dec  7 08:17:35 2020
...
if cap.isOpened():
    ...
    while(True):
        ...
        if scale > 0 and scale < 1:
            frame = cv2ImgAddText(frame, "Walking 行走中", 10, 20, (255, 0, 0), 30)  # 行走中
        if scale > 0.9 and scale < 2:
            frame = cv2ImgAddText(frame, "Falling 中间过程", 10, 20, (255, 0, 0), 30)  # 跌倒中
        if scale > 2:
            frame = cv2ImgAddText(frame, "Falled 跌倒了", 10, 20, (255, 0, 0), 30)  # 跌倒了
